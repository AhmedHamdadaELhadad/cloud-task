...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            vmid++;
            Vm vm3 = new Vm(vmid, brokerId, mips * 4/3, pesNumber, ram, bw, size, vmm, new CloudletSchedulerTimeShared());

            vmid++;
            Vm vm4 = new Vm(vmid, brokerId, mips * 3/4, pesNumber, ram, bw, size, vmm, new CloudletSchedulerTimeShared());
